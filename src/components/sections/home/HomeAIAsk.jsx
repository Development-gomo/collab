...
export default function AskAI({ data }) {
  ...
  return (
    <section id="next" className="ai-section relative overflow-hidden bg-white">
      {bgImage ? (
        ...
        <div className="flex flex-col md:justify-end md:flex-row gap-4">
          {ai_block.map((item, index) => (
            <motion.a
              ...
              className="group relative flex flex-col justify-between bg-(--color-warm-stone) rounded-lg pt-6 pb-8 pl-8 pr-6 min-h-[210px] w-full md:w-[300px] overflow-hidden cursor-pointer"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
